...
async def user_settings(user_id):
    ...
    get_webm = "Get WEBM"
    get_webm_msg = "Set to True if you want to get webm files when you send any existing video sticker. This way, you can add stickers from other people's packs using @Stickers. If False, bot will ignore the sticker."
    kang_mode = "Kang Mode"
    ...
    if kang_mode_db:
        ...
        kang_mode += cross
    if default_emojis_db := data['default_emojis']:
